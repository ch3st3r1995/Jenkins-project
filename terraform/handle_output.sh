...
terraform output --json | jq .ec2_instance1_public_ip.public_ip -r >> ../ansible/inventory/hosts
terraform output --json | jq .ec2_instance2_public_ip.public_ip -r >> ../ansible/inventory/hosts
