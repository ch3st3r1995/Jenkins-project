...
terraform output --json | jq .ec2_instance1.public_ip.value -r >> ../ansible/inventory/hosts
terraform output --json | jq .ec2_instance2.public_ip.value -r >> ../ansible/inventory/hosts
