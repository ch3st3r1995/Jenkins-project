...
terraform output --json | jq .ec2_instance1.value -r >> /var/lib/jenkins/workspace/Jenkins-project/ansible/inventory/hosts
terraform output --json | jq .ec2_instance2.value -r >> /var/lib/jenkins/workspace/Jenkins-project/ansible/inventory/hosts
